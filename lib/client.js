...
function ManagerTab(props) {
  ...
  const onToggle = async (entry) => {
    ...
    setNotice(null);
    setState((current) => current.status === "ready" ? { status: "ready", data: mapEntry(current.data, entry.entryId, (e) => ({ ...e, enabled: target })) } : current);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_section", "aria-busy": state.status === "loading", children: [
    ...
    picker !== null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_overlay", role: "dialog", "aria-label": t("moveToGroup"), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_dialog", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_dialogTitle", children: [
        t("moveToGroup"),
        ": ",
        moduleShortName(picker.entry.moduleName)
      ] }),
      picker.groups.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_groupList", children: picker.groups.map((name) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_pm_btn", onClick: () => {
        void moveTo(name);
      }, children: name }, name)) }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_empty", children: t("noDescription") }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_toolbar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
      ...
      picker.entry.groupOverridden ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_pm_btn", onClick: () => {
        void moveTo(null);
      }, children: t("restoreDefault") }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_toolbar", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_pm_btn", onClick: () => {
        setPicker(null);
      }, children: t("cancel") }) })
    ] }) }) : null
  ] });
}
function mapEntry(data, entryId, map) {
  return {
    ...data,
