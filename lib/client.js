window.__ModuleLoader__.load({ id: "dsh-usage-insights", factory: (require) => {
...
function CardShell(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_usage_card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_usage_cardRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_usage_title", title: props.title, children: props.title }),
      props.badges?.map((badge, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_usage_badge", children: badge }, index))
    ] }),
    props.description !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh_usage_desc", children: props.description }) : null,
    props.actions !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh_usage_actions", children: props.actions }) : null,
    props.details
  ] });
}
...
// src/client/entry-display.ts
function entryDescription(entry, lang, fallback) {
...
function matches(entry, query) {
  ...
  return [entry.moduleName, entry.entryId, entry.packageName ?? "", entry.group].some((value) => value !== "" && value.toLocaleLowerCase().includes(query));
}
function ManagerTab(props) {
  ...
  const [pickerEntry, setPickerEntry] = (0, import_react.useState)(null);
  const [groupNames, setGroupNames] = (0, import_react.useState)([]);
  const [pickNew, setPickNew] = (0, import_react.useState)("");
  const [showNewGroupToolbar, setShowNewGroupToolbar] = (0, import_react.useState)(false);
  const [toolbarNew, setToolbarNew] = (0, import_react.useState)("");
  ...
  (0, import_react.useEffect)(() => {
    ...
    const onDocDown = (event) => {
      if (pickerRef.current !== null && !pickerRef.current.contains(event.target) && !event.target.closest(".dsh_usage_groupButton")) {
        setPickerEntry(null);
      }
    };
  ...
  const filtered = (0, import_react.useMemo)(() => {
    if (state.status !== "ready") return { official: [], community: [], custom: [] };
    const pick = (entries) => entries.filter((e) => matches(e, normalized));
    return {
  ...
  const displayName = (entry) => entryDescription(entry, lang, t("noDescription"));
  const retry = () => {
  ...
  const commitMove = async (groupName) => {
    if (pickerEntry === null) return;
  ...
  const renderCard = (entry) => {
    ...
    if (entry.groupOverridden) badges.push(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { "data-kind": "patch", children: entry.group }, "g"));
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      CardShell,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_actionsWrap", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_usage_statusDot", "data-phase": phase, role: "img", "aria-label": phase, title: phase }),
              ...
              "button",
              {
                ...
                onClick: () => {
                  if (isPickerTarget) {
                    ...
                    void openPicker(entry);
                  }
                },
                children: t("groupButton")
              }
            ),
            entry.group === "community" && !entry.groupOverridden && entry.packageName !== null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "button",
              {
                type: "button",
          ...
          isPickerTarget ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_popover", ref: pickerRef, role: "listbox", "aria-label": t("moveToGroup"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_usage_popTitle", children: t("moveToGroup") }),
            groupNames.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_usage_groupList", children: groupNames.map((name) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", role: "option", className: "dsh_usage_popItem", onClick: () => {
              void commitMove(name);
            }, children: name }, name)) }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_toolbar", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "input",
                {
                  ...
                  onChange: (event) => {
                    setPickNew(event.currentTarget.value);
                  },
                  onKeyDown: (event) => {
                    if (event.key === "Enter") void createFromPicker();
                  }
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_usage_btn dsh_usage_btnPrimary", onClick: () => {
                void createFromPicker();
              }, children: t("newGroup") })
            ] }),
            pickerEntry.groupOverridden ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_usage_popItem dsh_usage_popReset", onClick: () => {
              void commitMove(null);
            }, children: t("restoreDefault") }) : null
          ] }) : null
        ] }),
        details: open ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_details", children: [
  ...
  const renderGroup = (title, entries, deletable = false) => {
    const open = !collapsed[title];
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_groupRow", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh_usage_groupCount", children: [
                "(",
                entries.length,
                ")"
              ] })
        ...
        deletable ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_usage_btn dsh_usage_btnDanger dsh_usage_groupDel", onClick: () => {
          void onDeleteGroup(title);
        }, children: t("deleteGroup") }) : null
      ] }),
      open ? entries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_usage_empty", children: t("emptyGroup") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_usage_cards", children: entries.map(renderCard) }) : null
    ] }, title);
  };
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_section", "aria-busy": state.status === "loading", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "dsh_usage_search", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "input",
        {
          type: "search",
          value: query,
      ...
      showNewGroupToolbar ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
            ...
            autoFocus: true,
            onChange: (event) => {
              setToolbarNew(event.currentTarget.value);
            },
            onKeyDown: (event) => {
              if (event.key === "Enter") void createFromToolbar();
              if (event.key === "Escape") setShowNewGroupToolbar(false);
            }
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_usage_btn dsh_usage_btnPrimary", onClick: () => {
          void createFromToolbar();
        }, children: t("confirm") }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_usage_btn", onClick: () => {
          setShowNewGroupToolbar(false);
        }, children: t("cancel") })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "dsh_usage_btn dsh_usage_btnPrimary", onClick: () => {
        setShowNewGroupToolbar(true);
      }, children: [
        "+ ",
        t("newGroup")
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_usage_btn", onClick: retry, children: t("retry") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_usage_notice", "data-error": notice?.error === true ? "true" : void 0, children: notice !== null ? notice.text : t("restartNotice") }),
    state.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_usage_status", children: t("search") }) : null,
    state.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_usage_status", children: [
      t("loadError"),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_usage_btn", onClick: retry, children: t("retry") })
    ] }) : null,
...
function MarketTab(props) {
  ...
  const renderCards = (items) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_usage_cards", children: items.map((item) => {
    const badges = [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      CardShell,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh_usage_badge", children: [
            "\u2B50 ",
            item.stars
          ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_usage_section", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_usage_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "dsh_usage_search", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "input",
        {
          type: "search",
          value: query,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dsh_usage_btn dsh_usage_btnPrimary", onClick: () => {
        void runSearch();
      }, children: t("search") }),
      searching ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dsh_usage_btn", onClick: backToBoard, children: t("backToBoard") }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_usage_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "button",
    ...
    notice !== null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_usage_notice", "data-error": notice.error ? "true" : void 0, children: notice.text }) : null,
    state.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_usage_status", children: t("marketSearching") }) : null,
    state.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_usage_status", children: [
      t("marketError"),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dsh_usage_btn", onClick: () => {
        void loadBoard(boardTab);
      }, children: t("retry") })
    ] }) : null,
    state.status === "done" ? state.items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_usage_empty", children: t("marketEmpty") }) : renderCards(state.items) : null
  ] });
}
...
var cssText = `
.dsh_usage_section { display: flex; flex-direction: column; gap: 12px; min-width: 0; }
.dsh_usage_toolbar { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
.dsh_usage_search { display: inline-flex; align-items: center; gap: 6px; flex: 1 1 220px; max-width: 340px; padding: 5px 10px; border: 1px solid var(--dsw-alias-border-l2); border-radius: 8px; background: var(--dsw-alias-bg-layer-1); }
.dsh_usage_search input { flex: 1; min-width: 0; border: none; outline: none; background: transparent; color: var(--dsw-alias-label-primary); font-size: 13px; }
.dsh_usage_search input::placeholder { color: var(--dsw-alias-label-tertiary); }
.dsh_usage_notice { padding: 8px 12px; border: 1px solid var(--dsw-alias-border-l2); border-radius: 8px; background: var(--dsw-alias-bg-layer-1); color: var(--dsw-alias-label-secondary); font-size: 12px; line-height: 18px; }
.dsh_usage_notice[data-error='true'] { border-color: var(--dsw-alias-state-danger-border, var(--dsw-alias-border-l2)); color: var(--dsw-alias-state-danger-fg, var(--dsw-alias-label-primary)); }
.dsh_usage_groupHead { display: flex; align-items: center; gap: 8px; width: 100%; border: none; background: transparent; padding: 6px 2px; cursor: pointer; color: var(--dsw-alias-label-primary); font-size: 14px; line-height: 22px; font-weight: 600; text-align: left; }
.dsh_usage_groupHead:hover { color: var(--dsw-alias-brand-primary); }
.dsh_usage_groupCount { color: var(--dsw-alias-label-tertiary); font-size: 12px; font-weight: 400; }
.dsh_usage_cards { display: flex; flex-direction: column; gap: 8px; }
.dsh_usage_card { display: flex; flex-direction: column; gap: 6px; padding: 10px 12px; border: 1px solid var(--dsw-alias-border-l2); border-radius: 10px; background: var(--dsw-alias-bg-layer-1); min-width: 0; }
.dsh_usage_cardRow { display: flex; align-items: center; gap: 8px; min-width: 0; }
.dsh_usage_title { flex: 1 1 auto; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--dsw-alias-label-primary); font-size: 13px; line-height: 20px; font-weight: 600; }
.dsh_usage_badge { flex: 0 0 auto; padding: 1px 8px; border-radius: 999px; font-size: 11px; line-height: 18px; color: var(--dsw-alias-label-secondary); background: var(--dsw-alias-bg-layer-2); }
.dsh_usage_badge[data-kind='protected'] { color: var(--dsw-alias-state-danger-fg, var(--dsw-alias-label-secondary)); }
.dsh_usage_badge[data-kind='patch'] { color: var(--dsw-alias-state-business-primary, var(--dsw-alias-label-secondary)); }
.dsh_usage_desc { color: var(--dsw-alias-label-secondary); font-size: 12px; line-height: 18px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
.dsh_usage_actions { display: flex; align-items: center; gap: 6px; flex-wrap: wrap; }
.dsh_usage_btn { border: 1px solid var(--dsw-alias-border-l2); border-radius: 6px; padding: 2px 10px; font-size: 12px; line-height: 20px; cursor: pointer; color: var(--dsw-alias-label-primary); background: var(--dsw-alias-bg-layer-2); }
.dsh_usage_btn:hover { border-color: var(--dsw-alias-brand-primary); }
.dsh_usage_btn:disabled { opacity: 0.5; cursor: default; }
.dsh_usage_btnPrimary { border-color: var(--dsw-alias-brand-primary); color: var(--dsw-alias-brand-primary); }
.dsh_usage_btnDanger { color: var(--dsw-alias-state-danger-fg, var(--dsw-alias-label-primary)); }
.dsh_usage_statusDot { width: 8px; height: 8px; border-radius: 50%; background: var(--dsw-alias-bg-layer-3); }
.dsh_usage_statusDot[data-phase='active'] { background: var(--dsw-alias-state-success-fg, #2f9e44); }
.dsh_usage_statusDot[data-phase='failed'] { background: var(--dsw-alias-state-danger-fg, #e03131); }
.dsh_usage_statusDot[data-phase='loading'] { background: var(--dsw-alias-brand-primary); }
.dsh_usage_details { display: flex; flex-direction: column; gap: 4px; padding: 8px 10px; border-top: 1px solid var(--dsw-alias-border-l1); font-size: 12px; line-height: 18px; color: var(--dsw-alias-label-secondary); min-width: 0; }
.dsh_usage_details a { color: var(--dsw-alias-brand-primary); text-decoration: none; overflow-wrap: anywhere; }
.dsh_usage_details code { color: var(--dsw-alias-label-primary); overflow-wrap: anywhere; }
.dsh_usage_status { padding: 24px 0; text-align: center; color: var(--dsw-alias-label-tertiary); font-size: 13px; }
.dsh_usage_empty { padding: 24px 0; text-align: center; color: var(--dsw-alias-label-tertiary); font-size: 13px; }
.dsh_usage_groupRow { display: flex; align-items: center; gap: 8px; }
.dsh_usage_groupRow .dsh_usage_groupHead { width: auto; flex: 1 1 auto; }
.dsh_usage_groupDel { flex: 0 0 auto; }
.dsh_usage_groupList { display: flex; flex-direction: column; gap: 6px; }
.dsh_usage_input { flex: 1; min-width: 0; padding: 5px 10px; border: 1px solid var(--dsw-alias-border-l2); border-radius: 6px; background: var(--dsw-alias-bg-layer-1); color: var(--dsw-alias-label-primary); font-size: 13px; }
.dsh_usage_input:focus { outline: none; border-color: var(--dsw-alias-brand-primary); }
.dsh_usage_actionsWrap { position: relative; }
.dsh_usage_newGroupInput { flex: 0 1 160px; }
.dsh_usage_popover { position: absolute; top: calc(100% + 6px); left: 0; z-index: 50; min-width: 200px; max-width: 260px; display: flex; flex-direction: column; gap: 6px; padding: 10px; border: 1px solid var(--dsw-alias-border-l2); border-radius: 10px; background: var(--dsw-alias-bg-layer-1); box-shadow: 0 4px 16px rgba(0, 0, 0, 0.18); }
.dsh_usage_popTitle { color: var(--dsw-alias-label-tertiary); font-size: 12px; }
.dsh_usage_popItem { display: block; width: 100%; text-align: left; border: none; background: transparent; padding: 5px 8px; border-radius: 6px; font-size: 13px; line-height: 20px; color: var(--dsw-alias-label-primary); cursor: pointer; }
.dsh_usage_popItem:hover { background: var(--dsw-alias-bg-layer-2); }
.dsh_usage_popReset { color: var(--dsw-alias-state-danger-fg, var(--dsw-alias-label-primary)); }
`;
...
function apply(ctx) {
  ...
  const list = async () => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/list"));
  const toggle = async (body) => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/toggle", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(body)
  }));
  const uninstall = async (packageName) => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/uninstall", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ packageName })
  }));
  const group = async (moduleName, groupName) => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/group", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ moduleName, groupName })
  }));
  const groupDelete = async (groupName) => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/group-delete", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ groupName })
  }));
  const groupCreate = async (groupName) => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/group-create", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ groupName })
  }));
  const groupList = async () => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/group-list"));
  const search = async (query) => jsonOrThrow(await globalThis.fetch(`/dsh-usage-insights/search?q=${encodeURIComponent(query)}`));
  const board = async (mode) => jsonOrThrow(await globalThis.fetch(`/dsh-usage-insights/search?mode=${mode}`));
  const install = async (spec) => jsonOrThrow(await globalThis.fetch("/dsh-usage-insights/install", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
