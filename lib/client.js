window.__ModuleLoader__.load({ id: "dsh-plugin-studio", factory: (require) => {
...
function apply(ctx) {
  ...
  const list = async () => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/list"));
  const toggle = async (body) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/toggle", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(body)
  }));
  const uninstall = async (packageName) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/uninstall", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ packageName })
  }));
  const group = async (moduleName, groupName) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/group", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ moduleName, groupName })
  }));
  const groupDelete = async (groupName) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/group-delete", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ groupName })
  }));
  const groupCreate = async (groupName) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/group-create", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ groupName })
  }));
  const groupList = async () => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/group-list"));
  const search = async (query) => jsonOrThrow(await globalThis.fetch(`/dsh-plugin-studio/search?q=${encodeURIComponent(query)}`));
  const board = async (mode) => jsonOrThrow(await globalThis.fetch(`/dsh-plugin-studio/search?mode=${mode}`));
  const install = async (spec) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-studio/install", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
