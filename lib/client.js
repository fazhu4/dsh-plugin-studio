...
function CardShell(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dspm_card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dspm_cardRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dspm_title", title: props.title, children: props.title }),
      props.badges?.map((badge, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dspm_badge", children: badge }, index))
    ] }),
    props.description !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dspm_desc", children: props.description }) : null,
    props.actions !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dspm_actions", children: props.actions }) : null,
    props.details
  ] });
}
...
function ManagerTab(props) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const onDocDown = (event) => {
      if (pickerRef.current !== null && !pickerRef.current.contains(event.target) && !event.target.closest(".dspm_groupButton")) {
        setPickerEntry(null);
      }
    };
  ...
  const renderCard = (entry) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      CardShell,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_actionsWrap", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dspm_statusDot", "data-phase": phase, role: "img", "aria-label": phase, title: phase }),
          ...
          isPickerTarget ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_popover", ref: pickerRef, role: "listbox", "aria-label": t("moveToGroup"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dspm_popTitle", children: t("moveToGroup") }),
            groupNames.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dspm_groupList", children: groupNames.map((name) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", role: "option", className: "dspm_popItem", onClick: () => {
              void commitMove(name);
            }, children: name }, name)) }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_toolbar", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "input",
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dspm_btn dspm_btnPrimary", onClick: () => {
                void createFromPicker();
              }, children: t("newGroup") })
            ] }),
            pickerEntry.groupOverridden ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dspm_popItem dspm_popReset", onClick: () => {
              void commitMove(null);
            }, children: t("restoreDefault") }) : null
          ] }) : null
        ] }),
        details: open ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_details", children: [
  ...
  const renderGroup = (title, entries, deletable = false) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_groupRow", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dspm_groupCount", children: [
                "(",
                entries.length,
                ")"
              ] })
        ...
        deletable ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dspm_btn dspm_btnDanger dspm_groupDel", onClick: () => {
          void onDeleteGroup(title);
        }, children: t("deleteGroup") }) : null
      ] }),
      open ? entries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dspm_empty", children: t("emptyGroup") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dspm_cards", children: entries.map(renderCard) }) : null
    ] }, title);
  };
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_section", "aria-busy": state.status === "loading", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "dspm_search", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "input",
        {
          type: "search",
          value: query,
      ...
      showNewGroupToolbar ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dspm_btn", onClick: () => {
          setShowNewGroupToolbar(false);
        }, children: t("cancel") })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "dspm_btn dspm_btnPrimary", onClick: () => {
        setShowNewGroupToolbar(true);
      }, children: [
        "+ ",
        t("newGroup")
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dspm_btn", onClick: retry, children: t("retry") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dspm_notice", "data-error": notice?.error === true ? "true" : void 0, children: notice !== null ? notice.text : t("restartNotice") }),
    state.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dspm_status", children: t("search") }) : null,
    state.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dspm_status", children: [
      t("loadError"),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dspm_btn", onClick: retry, children: t("retry") })
    ] }) : null,
...
function MarketTab(props) {
  ...
  const renderCards = (items) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dspm_cards", children: items.map((item) => {
    const badges = [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      CardShell,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dspm_badge", children: [
            "\u2B50 ",
            item.stars
          ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dspm_section", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dspm_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "dspm_search", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "input",
        {
          type: "search",
          value: query,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dspm_btn dspm_btnPrimary", onClick: () => {
        void runSearch();
      }, children: t("search") }),
      searching ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dspm_btn", onClick: backToBoard, children: t("backToBoard") }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dspm_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "button",
    ...
    notice !== null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dspm_notice", "data-error": notice.error ? "true" : void 0, children: notice.text }) : null,
    state.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dspm_status", children: t("marketSearching") }) : null,
    state.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dspm_status", children: [
      t("marketError"),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dspm_btn", onClick: () => {
        void loadBoard(boardTab);
      }, children: t("retry") })
    ] }) : null,
    state.status === "done" ? state.items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dspm_empty", children: t("marketEmpty") }) : renderCards(state.items) : null
  ] });
}
