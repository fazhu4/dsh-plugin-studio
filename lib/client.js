...
function CardShell(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_ps_card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_ps_cardRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_ps_title", title: props.title, children: props.title }),
      props.badges?.map((badge, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_ps_badge", children: badge }, index))
    ] }),
    props.description !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh_ps_desc", children: props.description }) : null,
    props.actions !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh_ps_actions", children: props.actions }) : null,
    props.details
  ] });
}
...
function ManagerTab(props) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const onDocDown = (event) => {
      if (pickerRef.current !== null && !pickerRef.current.contains(event.target) && !event.target.closest(".dsh_ps_groupButton")) {
        setPickerEntry(null);
      }
    };
  ...
  const renderCard = (entry) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      CardShell,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_actionsWrap", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dsh_ps_statusDot", "data-phase": phase, role: "img", "aria-label": phase, title: phase }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "button",
              {
                type: "button",
                className: "dsh_ps_btn dsh_ps_btnPrimary",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              ...
              {
                type: "button",
                className: "dsh_ps_btn dsh_ps_groupButton",
            ...
            entry.group === "community" && !entry.groupOverridden && entry.packageName !== null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              ...
              {
                type: "button",
                className: "dsh_ps_btn dsh_ps_btnDanger",
                disabled: protectedModule || busy[entry.entryId] === true,
                onClick: () => {
          ...
          isPickerTarget ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_popover", ref: pickerRef, role: "listbox", "aria-label": t("moveToGroup"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_ps_popTitle", children: t("moveToGroup") }),
            groupNames.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_ps_groupList", children: groupNames.map((name) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", role: "option", className: "dsh_ps_popItem", onClick: () => {
              void commitMove(name);
            }, children: name }, name)) }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_toolbar", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "input",
                {
                  className: "dsh_ps_input",
                  type: "text",
                  value: pickNew,
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_ps_btn dsh_ps_btnPrimary", onClick: () => {
                void createFromPicker();
              }, children: t("newGroup") })
            ] }),
            pickerEntry.groupOverridden ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_ps_popItem dsh_ps_popReset", onClick: () => {
              void commitMove(null);
            }, children: t("restoreDefault") }) : null
          ] }) : null
        ] }),
        details: open ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_details", children: [
  ...
  const renderGroup = (title, entries, deletable = false) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_groupRow", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            type: "button",
            className: "dsh_ps_groupHead",
            "aria-expanded": open,
            onClick: () => {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dsh_ps_groupCount", children: [
                "(",
                entries.length,
                ")"
              ] })
        ...
        deletable ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_ps_btn dsh_ps_btnDanger dsh_ps_groupDel", onClick: () => {
          void onDeleteGroup(title);
        }, children: t("deleteGroup") }) : null
      ] }),
      open ? entries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_ps_empty", children: t("emptyGroup") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_ps_cards", children: entries.map(renderCard) }) : null
    ] }, title);
  };
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_section", "aria-busy": state.status === "loading", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "dsh_ps_search", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "input",
        {
          type: "search",
          value: query,
      ...
      showNewGroupToolbar ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "input",
          {
            className: "dsh_ps_input dsh_ps_newGroupInput",
            type: "text",
            value: toolbarNew,
            placeholder: t("newGroupPlaceholder"),
            autoFocus: true,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_ps_btn", onClick: () => {
          setShowNewGroupToolbar(false);
        }, children: t("cancel") })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "dsh_ps_btn dsh_ps_btnPrimary", onClick: () => {
        setShowNewGroupToolbar(true);
      }, children: [
        "+ ",
        t("newGroup")
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_ps_btn", onClick: retry, children: t("retry") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_ps_notice", "data-error": notice?.error === true ? "true" : void 0, children: notice !== null ? notice.text : t("restartNotice") }),
    state.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_ps_status", children: t("search") }) : null,
    state.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_ps_status", children: [
      t("loadError"),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_ps_btn", onClick: retry, children: t("retry") })
    ] }) : null,
...
function MarketTab(props) {
  ...
  const renderCards = (items) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_ps_cards", children: items.map((item) => {
    const badges = [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      CardShell,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dsh_ps_badge", children: [
            "\u2B50 ",
            item.stars
          ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_ps_section", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_ps_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "dsh_ps_search", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "input",
        {
          type: "search",
          value: query,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dsh_ps_btn dsh_ps_btnPrimary", onClick: () => {
        void runSearch();
      }, children: t("search") }),
      searching ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dsh_ps_btn", onClick: backToBoard, children: t("backToBoard") }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_ps_toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "button",
        {
          type: "button",
          className: boardTab === "top" ? "dsh_ps_btn dsh_ps_btnPrimary" : "dsh_ps_btn",
          onClick: () => {
            setBoardTab("top");
          },
          children: t("boardTop")
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "button",
        {
          ...
          className: boardTab === "rising" ? "dsh_ps_btn dsh_ps_btnPrimary" : "dsh_ps_btn",
          onClick: () => {
            setBoardTab("rising");
          },
    ...
    notice !== null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_ps_notice", "data-error": notice.error ? "true" : void 0, children: notice.text }) : null,
    state.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_ps_status", children: t("marketSearching") }) : null,
    state.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dsh_ps_status", children: [
      t("marketError"),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", className: "dsh_ps_btn", onClick: () => {
        void loadBoard(boardTab);
      }, children: t("retry") })
    ] }) : null,
    state.status === "done" ? state.items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dsh_ps_empty", children: t("marketEmpty") }) : renderCards(state.items) : null
  ] });
}
