...
function ManagerTab(props) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const onDocDown = (event) => {
      if (pickerRef.current !== null && !pickerRef.current.contains(event.target) && !event.target.closest(".dsh_pm_groupButton")) {
        setPickerEntry(null);
      }
    };
  ...
  const renderCard = (entry) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      CardShell,
      {
        ...
        actions: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_actionsWrap", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_actions", children: [
          ...
          isPickerTarget ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_popover", ref: pickerRef, role: "listbox", "aria-label": t("moveToGroup"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_popTitle", children: t("moveToGroup") }),
            groupNames.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_groupList", children: groupNames.map((name) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", role: "option", className: "dsh_pm_popItem", onClick: () => {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_toolbar", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_pm_btn dsh_pm_btnPrimary", onClick: () => {
                void createFromPicker();
              }, children: t("newGroup") })
            ] }),
            pickerEntry.groupOverridden ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_pm_popItem dsh_pm_popReset", onClick: () => {
  ...
  const renderGroup = (title, entries, deletable = false) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_groupRow", children: [
        ...
        deletable ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_pm_btn dsh_pm_btnDanger dsh_pm_groupDel", onClick: () => {
          void onDeleteGroup(title);
        }, children: t("deleteGroup") }) : null
      ] }),
      open ? entries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_empty", children: t("emptyGroup") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dsh_pm_cards", children: entries.map(renderCard) }) : null
    ] }, title);
  };
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_section", "aria-busy": state.status === "loading", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dsh_pm_toolbar", children: [
      ...
      showNewGroupToolbar ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "dsh_pm_btn", onClick: () => {
          setShowNewGroupToolbar(false);
        }, children: t("cancel") })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "dsh_pm_btn dsh_pm_btnPrimary", onClick: () => {
...
function apply(ctx) {
  ...
  const group = async (moduleName, groupName) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-manager/group", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ moduleName, groupName })
  }));
  const groupDelete = async (groupName) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-manager/group-delete", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ groupName })
  }));
  const groupCreate = async (groupName) => jsonOrThrow(await globalThis.fetch("/dsh-plugin-manager/group-create", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ groupName })
  }));
  const groupList = async () => jsonOrThrow(await globalThis.fetch("/dsh-plugin-manager/group-list"));
